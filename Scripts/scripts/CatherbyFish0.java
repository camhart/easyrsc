...
public class CatherbyFish0 extends Script implements MessageListener {
	...
	public CatherbyFish0(Extension e) {
		super(e);
	}
		...
		if(type == 3 && status == 0) {
			for(String s : fishingResults) {
				if(message.startsWith(s)) {
					...
					lastActionThreshold = random(300, 550);
					return;
				}
			}
